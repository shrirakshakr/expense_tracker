...
$expensecategory = "";
$account_id = 1; // Assuming a default account_id, you can change this as needed
...
if (isset($_POST['add'])) {
    ...
    $expenses = "INSERT INTO transactions (user_id, account_id, category_id, amount, tdate, description) VALUES ('$userid', '$account_id', '$expensecategory', '$expenseamount', '$expensedate', 'Expense')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE transactions SET amount='$expenseamount', tdate='$expensedate', category_id='$expensecategory' WHERE user_id='$userid' AND transaction_id='$id'";
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $update = true;
    $record = mysqli_query($con, "SELECT * FROM transactions WHERE user_id='$userid' AND transaction_id=$id");
