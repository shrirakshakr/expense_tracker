<?php
    ...
    $exp_category_dc = mysqli_query($con, "SELECT c.category_name FROM transactions t JOIN table_categories c ON t.category_id = c.category_id WHERE t.user_id = '$userid' AND t.tdate >= '$one_month_ago' GROUP BY c.category_name");
    $exp_amt_dc = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t JOIN table_categories c ON t.category_id = c.category_id WHERE t.user_id = '$userid' AND t.tdate >= '$one_month_ago' GROUP BY c.category_name");
    
    $one_week_ago = date("Y-m-d", strtotime("-1 week"));
    $exp_date_line = mysqli_query($con, "SELECT DATE_FORMAT(t.tdate, '%b %d') AS day_month FROM transactions t WHERE t.user_id = '$userid' AND t.tdate >= '$one_week_ago' GROUP BY t.tdate");
    $exp_amt_line = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t WHERE t.user_id = '$userid' AND t.tdate >= '$one_week_ago' GROUP BY t.tdate");
...
$today_expense = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t WHERE t.user_id = '$userid' AND t.tdate = CURDATE()");
$yesterday_expense = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t WHERE t.user_id = '$userid' AND t.tdate = DATE_SUB(CURDATE(), INTERVAL 1 DAY)");
$this_week_expense = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t WHERE t.user_id = '$userid' AND t.tdate >= DATE_SUB(CURDATE(), INTERVAL 1 WEEK)");
$this_month_expense = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t WHERE t.user_id = '$userid' AND t.tdate >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH)");
$this_year_expense = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t WHERE t.user_id = '$userid' AND t.tdate >= DATE_SUB(CURDATE(), INTERVAL 1 YEAR)");
$total_expense = mysqli_query($con, "SELECT SUM(t.amount) FROM transactions t WHERE t.user_id = '$userid'");
